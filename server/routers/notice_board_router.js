...
// // router.get("/list/:page/:perPage/", SessionMiddleware.pass, NoticeBoardController.searchingList);
router.get("/list/:page/:perPage/", NoticeBoardController.searchingList);

// // router.get("/list/:page/:perPage/:searchKey/:searchWord", SessionMiddleware.pass, NoticeBoardController.searchingList);
router.get("/list/:page/:perPage/:searchKey/:searchWord", NoticeBoardController.searchingList);
